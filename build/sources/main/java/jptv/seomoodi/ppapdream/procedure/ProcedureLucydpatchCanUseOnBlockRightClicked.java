...
public class ProcedureLucydpatchCanUseOnBlockRightClicked extends ElementsPpapdreamMod.ModElement {
	public ProcedureLucydpatchCanUseOnBlockRightClicked(ElementsPpapdreamMod instance) {
		super(instance, 182);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure LucydpatchCanUseOnBlockRightClicked!");
			return;
		}
