...
public class GuiGuiPgeNecktie extends ElementsPpapdreamMod.ModElement {
	public static int GUIID = 57;
	public static HashMap guistate = new HashMap();
	public GuiGuiPgeNecktie(ElementsPpapdreamMod instance) {
		super(instance, 223);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("ppapdream:textures/pge_necktie.png"));
