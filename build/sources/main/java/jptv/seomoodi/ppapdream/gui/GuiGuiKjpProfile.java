...
public class GuiGuiKjpProfile extends ElementsPpapdreamMod.ModElement {
	public static int GUIID = 15;
	public static HashMap guistate = new HashMap();
	public GuiGuiKjpProfile(ElementsPpapdreamMod instance) {
		super(instance, 106);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("ppapdream:textures/jappap_profile.png"));
