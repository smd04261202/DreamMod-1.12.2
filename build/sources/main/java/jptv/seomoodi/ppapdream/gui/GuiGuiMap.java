...
public class GuiGuiMap extends ElementsPpapdreamMod.ModElement {
	public static int GUIID = 38;
	public static HashMap guistate = new HashMap();
	public GuiGuiMap(ElementsPpapdreamMod instance) {
		super(instance, 157);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("ppapdream:textures/lucid_map.png"));
