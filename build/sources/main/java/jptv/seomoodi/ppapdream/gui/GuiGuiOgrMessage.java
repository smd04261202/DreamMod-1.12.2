...
public class GuiGuiOgrMessage extends ElementsPpapdreamMod.ModElement {
	public static int GUIID = 91;
	public static HashMap guistate = new HashMap();
	public GuiGuiOgrMessage(ElementsPpapdreamMod instance) {
		super(instance, 339);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("ppapdream:textures/ogr_message.png"));
