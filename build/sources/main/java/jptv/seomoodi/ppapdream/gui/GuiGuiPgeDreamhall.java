...
public class GuiGuiPgeDreamhall extends ElementsPpapdreamMod.ModElement {
	public static int GUIID = 95;
	public static HashMap guistate = new HashMap();
	public GuiGuiPgeDreamhall(ElementsPpapdreamMod instance) {
		super(instance, 347);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("ppapdream:textures/pge_dreamhall.png"));
