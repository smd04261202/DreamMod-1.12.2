...
public class GuiGuiGloDrawing extends ElementsPpapdreamMod.ModElement {
	public static int GUIID = 11;
	public static HashMap guistate = new HashMap();
	public GuiGuiGloDrawing(ElementsPpapdreamMod instance) {
		super(instance, 99);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("ppapdream:textures/leon_drawing.png"));
			this.drawTexturedModalRect(this.guiLeft + 0, this.guiTop + -4, 0, 0, 256, 256);
		}
