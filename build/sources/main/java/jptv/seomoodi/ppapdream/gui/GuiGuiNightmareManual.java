...
public class GuiGuiNightmareManual extends ElementsPpapdreamMod.ModElement {
	public static int GUIID = 94;
	public static HashMap guistate = new HashMap();
	public GuiGuiNightmareManual(ElementsPpapdreamMod instance) {
		super(instance, 345);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("ppapdream:textures/nightmaredlc.png"));
