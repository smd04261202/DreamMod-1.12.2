...
public class GuiGuiHotelReceipt01 extends ElementsPpapdreamMod.ModElement {
	public static int GUIID = 61;
	public static HashMap guistate = new HashMap();
	public GuiGuiHotelReceipt01(ElementsPpapdreamMod instance) {
		super(instance, 227);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("ppapdream:textures/hotel_receipt01.png"));
