...
public class GuiGuiOgrSocks extends ElementsPpapdreamMod.ModElement {
	public static int GUIID = 56;
	public static HashMap guistate = new HashMap();
	public GuiGuiOgrSocks(ElementsPpapdreamMod instance) {
		super(instance, 222);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("ppapdream:textures/ogr_socks.png"));
