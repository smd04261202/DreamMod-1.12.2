...
public class GuiGuiPpapPicture02 extends ElementsPpapdreamMod.ModElement {
	public static int GUIID = 109;
	public static HashMap guistate = new HashMap();
	public GuiGuiPpapPicture02(ElementsPpapdreamMod instance) {
		super(instance, 406);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("ppapdream:textures/ppap_picture2.png"));
