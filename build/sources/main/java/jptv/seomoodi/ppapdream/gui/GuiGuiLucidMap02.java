...
public class GuiGuiLucidMap02 extends ElementsPpapdreamMod.ModElement {
	public static int GUIID = 60;
	public static HashMap guistate = new HashMap();
	public GuiGuiLucidMap02(ElementsPpapdreamMod instance) {
		super(instance, 226);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("ppapdream:textures/lucid_map2.png"));
