...
public class GuiGuiPenguinPaper extends ElementsPpapdreamMod.ModElement {
	public static int GUIID = 47;
	public static HashMap guistate = new HashMap();
	public GuiGuiPenguinPaper(ElementsPpapdreamMod instance) {
		super(instance, 173);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("ppapdream:textures/penguin_paper1.png"));
