...
public class GuiGuiDlcMemory extends ElementsPpapdreamMod.ModElement {
	public static int GUIID = 83;
	public static HashMap guistate = new HashMap();
	public GuiGuiDlcMemory(ElementsPpapdreamMod instance) {
		super(instance, 301);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("ppapdream:textures/rememberdlc.png"));
