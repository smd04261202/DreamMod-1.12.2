...
public class GuiGuiAbhPhotoCard extends ElementsPpapdreamMod.ModElement {
	public static int GUIID = 5;
	public static HashMap guistate = new HashMap();
	public GuiGuiAbhPhotoCard(ElementsPpapdreamMod instance) {
		super(instance, 88);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("ppapdream:textures/abh_photocard.png"));
			this.drawTexturedModalRect(this.guiLeft + 0, this.guiTop + 1, 0, 0, 256, 256);
		}
