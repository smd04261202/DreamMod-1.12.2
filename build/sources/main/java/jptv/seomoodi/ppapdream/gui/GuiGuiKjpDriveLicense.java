...
public class GuiGuiKjpDriveLicense extends ElementsPpapdreamMod.ModElement {
	public static int GUIID = 19;
	public static HashMap guistate = new HashMap();
	public GuiGuiKjpDriveLicense(ElementsPpapdreamMod instance) {
		super(instance, 113);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("ppapdream:textures/kjp_drivelicense.png"));
			this.drawTexturedModalRect(this.guiLeft + -2, this.guiTop + -4, 0, 0, 256, 256);
		}
