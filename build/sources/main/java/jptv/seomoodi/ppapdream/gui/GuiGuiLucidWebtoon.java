...
public class GuiGuiLucidWebtoon extends ElementsPpapdreamMod.ModElement {
	public static int GUIID = 92;
	public static HashMap guistate = new HashMap();
	public GuiGuiLucidWebtoon(ElementsPpapdreamMod instance) {
		super(instance, 341);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("ppapdream:textures/lucidwebtoon.png"));
