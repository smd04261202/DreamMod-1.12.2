...
public class GuiGuiTreasureFinalMap extends ElementsPpapdreamMod.ModElement {
	public static int GUIID = 48;
	public static HashMap guistate = new HashMap();
	public GuiGuiTreasureFinalMap(ElementsPpapdreamMod instance) {
		super(instance, 175);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("ppapdream:textures/treasure_finalmap.png"));
