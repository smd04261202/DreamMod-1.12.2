...
public class GuiGuiAbhPicture extends ElementsPpapdreamMod.ModElement {
	public static int GUIID = 102;
	public static HashMap guistate = new HashMap();
	public GuiGuiAbhPicture(ElementsPpapdreamMod instance) {
		super(instance, 381);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("ppapdream:textures/abh_picture.png"));
