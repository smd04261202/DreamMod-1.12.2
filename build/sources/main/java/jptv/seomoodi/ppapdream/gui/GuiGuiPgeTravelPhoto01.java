...
public class GuiGuiPgeTravelPhoto01 extends ElementsPpapdreamMod.ModElement {
	public static int GUIID = 12;
	public static HashMap guistate = new HashMap();
	public GuiGuiPgeTravelPhoto01(ElementsPpapdreamMod instance) {
		super(instance, 101);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("ppapdream:textures/pge_travelphoto01.png"));
			this.drawTexturedModalRect(this.guiLeft + -2, this.guiTop + -5, 0, 0, 256, 256);
		}
