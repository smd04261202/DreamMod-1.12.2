...
public class GuiGuiDlcAdvertising extends ElementsPpapdreamMod.ModElement {
	public static int GUIID = 65;
	public static HashMap guistate = new HashMap();
	public GuiGuiDlcAdvertising(ElementsPpapdreamMod instance) {
		super(instance, 241);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("ppapdream:textures/dlc_advertising.png"));
