...
public class GuiGuiHotelLight extends ElementsPpapdreamMod.ModElement {
	public static int GUIID = 51;
	public static HashMap guistate = new HashMap();
	public GuiGuiHotelLight(ElementsPpapdreamMod instance) {
		super(instance, 189);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 80, 35) {
			}));
			int si;
			int sj;
			for (si = 0; si < 3; ++si)
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("ppapdream:textures/gui_hotel_light.png");
		@Override
