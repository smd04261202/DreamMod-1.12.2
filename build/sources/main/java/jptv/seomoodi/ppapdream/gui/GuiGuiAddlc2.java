...
public class GuiGuiAddlc2 extends ElementsPpapdreamMod.ModElement {
	public static int GUIID = 78;
	public static HashMap guistate = new HashMap();
	public GuiGuiAddlc2(ElementsPpapdreamMod instance) {
		super(instance, 288);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("ppapdream:textures/lucid_addlc2.png"));
