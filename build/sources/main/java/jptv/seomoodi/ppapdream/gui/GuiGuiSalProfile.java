...
public class GuiGuiSalProfile extends ElementsPpapdreamMod.ModElement {
	public static int GUIID = 7;
	public static HashMap guistate = new HashMap();
	public GuiGuiSalProfile(ElementsPpapdreamMod instance) {
		super(instance, 90);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("ppapdream:textures/alak_profile.png"));
			this.drawTexturedModalRect(this.guiLeft + -3, this.guiTop + -7, 0, 0, 256, 256);
		}
