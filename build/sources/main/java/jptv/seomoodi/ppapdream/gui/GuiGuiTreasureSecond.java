...
public class GuiGuiTreasureSecond extends ElementsPpapdreamMod.ModElement {
	public static int GUIID = 49;
	public static HashMap guistate = new HashMap();
	public GuiGuiTreasureSecond(ElementsPpapdreamMod instance) {
		super(instance, 179);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("ppapdream:textures/treasure_second.png"));
