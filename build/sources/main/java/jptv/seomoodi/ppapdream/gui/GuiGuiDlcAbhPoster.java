...
public class GuiGuiDlcAbhPoster extends ElementsPpapdreamMod.ModElement {
	public static int GUIID = 8;
	public static HashMap guistate = new HashMap();
	public GuiGuiDlcAbhPoster(ElementsPpapdreamMod instance) {
		super(instance, 94);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("ppapdream:textures/dlc_abh_poster.png"));
