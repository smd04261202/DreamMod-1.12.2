...
public class GuiGuiHsdDiary extends ElementsPpapdreamMod.ModElement {
	public static int GUIID = 52;
	public static HashMap guistate = new HashMap();
	public GuiGuiHsdDiary(ElementsPpapdreamMod instance) {
		super(instance, 204);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("ppapdream:textures/hsd_diary.png"));
