...
public class GuiGuiMsgApplication extends ElementsPpapdreamMod.ModElement {
	public static int GUIID = 31;
	public static HashMap guistate = new HashMap();
	public GuiGuiMsgApplication(ElementsPpapdreamMod instance) {
		super(instance, 138);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("ppapdream:textures/msg_application.png"));
