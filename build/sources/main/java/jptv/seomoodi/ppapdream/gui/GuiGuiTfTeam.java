...
public class GuiGuiTfTeam extends ElementsPpapdreamMod.ModElement {
	public static int GUIID = 75;
	public static HashMap guistate = new HashMap();
	public GuiGuiTfTeam(ElementsPpapdreamMod instance) {
		super(instance, 283);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("ppapdream:textures/lucid_tfteam.png"));
