...
public class GuiGuiPgeProfile extends ElementsPpapdreamMod.ModElement {
	public static int GUIID = 16;
	public static HashMap guistate = new HashMap();
	public GuiGuiPgeProfile(ElementsPpapdreamMod instance) {
		super(instance, 108);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("ppapdream:textures/peng_profile.png"));
			this.drawTexturedModalRect(this.guiLeft + -2, this.guiTop + -3, 0, 0, 256, 256);
		}
