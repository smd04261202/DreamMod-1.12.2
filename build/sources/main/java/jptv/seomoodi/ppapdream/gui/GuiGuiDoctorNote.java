...
public class GuiGuiDoctorNote extends ElementsPpapdreamMod.ModElement {
	public static int GUIID = 88;
	public static HashMap guistate = new HashMap();
	public GuiGuiDoctorNote(ElementsPpapdreamMod instance) {
		super(instance, 333);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("ppapdream:textures/doctor_note.png"));
