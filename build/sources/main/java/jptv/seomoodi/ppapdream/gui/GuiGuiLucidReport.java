...
public class GuiGuiLucidReport extends ElementsPpapdreamMod.ModElement {
	public static int GUIID = 72;
	public static HashMap guistate = new HashMap();
	public GuiGuiLucidReport(ElementsPpapdreamMod instance) {
		super(instance, 278);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("ppapdream:textures/lucid_report.png"));
