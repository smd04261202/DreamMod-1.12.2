...
public class GuiGuiAbhPracticeNote extends ElementsPpapdreamMod.ModElement {
	public static int GUIID = 6;
	public static HashMap guistate = new HashMap();
	public GuiGuiAbhPracticeNote(ElementsPpapdreamMod instance) {
		super(instance, 89);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("ppapdream:textures/abh_practicenote.png"));
			this.drawTexturedModalRect(this.guiLeft + -2, this.guiTop + -1, 0, 0, 256, 256);
		}
