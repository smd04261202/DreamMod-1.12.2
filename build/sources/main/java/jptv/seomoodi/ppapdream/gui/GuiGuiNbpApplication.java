...
public class GuiGuiNbpApplication extends ElementsPpapdreamMod.ModElement {
	public static int GUIID = 40;
	public static HashMap guistate = new HashMap();
	public GuiGuiNbpApplication(ElementsPpapdreamMod instance) {
		super(instance, 161);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("ppapdream:textures/nbp_application.png"));
