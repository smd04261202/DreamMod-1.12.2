...
public class GuiGuiLucidUpdate extends ElementsPpapdreamMod.ModElement {
	public static int GUIID = 54;
	public static HashMap guistate = new HashMap();
	public GuiGuiLucidUpdate(ElementsPpapdreamMod instance) {
		super(instance, 206);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("ppapdream:textures/lucid_update.png"));
