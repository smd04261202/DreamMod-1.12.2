...
public class GuiGuiPgeMemo03 extends ElementsPpapdreamMod.ModElement {
	public static int GUIID = 97;
	public static HashMap guistate = new HashMap();
	public GuiGuiPgeMemo03(ElementsPpapdreamMod instance) {
		super(instance, 349);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("ppapdream:textures/pge_memo03.png"));
