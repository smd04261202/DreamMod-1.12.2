...
public class GuiGuiPpapPicture01 extends ElementsPpapdreamMod.ModElement {
	public static int GUIID = 108;
	public static HashMap guistate = new HashMap();
	public GuiGuiPpapPicture01(ElementsPpapdreamMod instance) {
		super(instance, 405);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("ppapdream:textures/ppap_picture.png"));
