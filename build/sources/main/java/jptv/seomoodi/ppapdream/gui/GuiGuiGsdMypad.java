...
public class GuiGuiGsdMypad extends ElementsPpapdreamMod.ModElement {
	public static int GUIID = 18;
	public static HashMap guistate = new HashMap();
	public GuiGuiGsdMypad(ElementsPpapdreamMod instance) {
		super(instance, 111);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("ppapdream:textures/gsd_mypad.png"));
			this.drawTexturedModalRect(this.guiLeft + -1, this.guiTop + 0, 0, 0, 256, 256);
		}
