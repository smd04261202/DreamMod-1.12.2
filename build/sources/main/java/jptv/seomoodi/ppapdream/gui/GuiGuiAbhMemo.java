...
public class GuiGuiAbhMemo extends ElementsPpapdreamMod.ModElement {
	public static int GUIID = 105;
	public static HashMap guistate = new HashMap();
	public GuiGuiAbhMemo(ElementsPpapdreamMod instance) {
		super(instance, 387);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("ppapdream:textures/abh_memo.png"));
