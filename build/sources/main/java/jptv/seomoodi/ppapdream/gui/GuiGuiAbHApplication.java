...
public class GuiGuiAbHApplication extends ElementsPpapdreamMod.ModElement {
	public static int GUIID = 28;
	public static HashMap guistate = new HashMap();
	public GuiGuiAbHApplication(ElementsPpapdreamMod instance) {
		super(instance, 135);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("ppapdream:textures/abh_application.png"));
