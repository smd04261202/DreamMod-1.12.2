...
public class ProcedurePhoneBellRightClickedInAir extends ElementsPpapdreamMod.ModElement {
	public ProcedurePhoneBellRightClickedInAir(ElementsPpapdreamMod instance) {
		super(instance, 201);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure PhoneBellRightClickedInAir!");
			return;
		}
