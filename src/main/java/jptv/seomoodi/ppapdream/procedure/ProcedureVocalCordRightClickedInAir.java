...
public class ProcedureVocalCordRightClickedInAir extends ElementsPpapdreamMod.ModElement {
	public ProcedureVocalCordRightClickedInAir(ElementsPpapdreamMod instance) {
		super(instance, 210);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure VocalCordRightClickedInAir!");
			return;
		}
