...
import jptv.seomoodi.ppapdream.item.ItemDlcNightmare;
...
public class ProcedureALucydpatchCanUseOnBlockRightClicked extends ElementsPpapdreamMod.ModElement {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if ((((entity instanceof EntityLivingBase) ? ((EntityLivingBase) entity).getHeldItemMainhand() : ItemStack.EMPTY)
				.getItem() == new ItemStack(ItemDlcNightmare.block, (int) (1)).getItem())) {
			if (entity instanceof EntityPlayer && !entity.world.isRemote) {
				((EntityPlayer) entity).sendStatusMessage(new TextComponentString("\u00a7e\uc545\ubabdDLC v4.0.2-beta"), (true));
			}
			if (entity instanceof EntityPlayer)
				((EntityPlayer) entity).inventory.clearMatchingItems(new ItemStack(ItemDlcNightmare.block, (int) (1)).getItem(), -1, (int) 1, null);
		} else {
			{
				Entity _ent = entity;
