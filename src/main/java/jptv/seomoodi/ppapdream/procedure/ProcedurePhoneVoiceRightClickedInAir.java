...
public class ProcedurePhoneVoiceRightClickedInAir extends ElementsPpapdreamMod.ModElement {
	public ProcedurePhoneVoiceRightClickedInAir(ElementsPpapdreamMod instance) {
		super(instance, 203);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure PhoneVoiceRightClickedInAir!");
			return;
		}
