...
public class EntityDreamFishPink extends ElementsPpapdreamMod.ModElement {
	public static final int ENTITYID = 11;
	public static final int ENTITYID_RANGED = 12;
	public EntityDreamFishPink(ElementsPpapdreamMod instance) {
		super(instance, 41);
	}
	...
	public void initElements() {
		elements.entities
				.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("ppapdream", "dream_fish_pink"), ENTITYID)
						.name("dream_fish_pink").tracker(64, 3, true).egg(-52327, -52327).build());
	}
