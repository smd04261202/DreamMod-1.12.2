...
public class GuiGuiNbpLetter extends ElementsPpapdreamMod.ModElement {
	public static int GUIID = 76;
	public static HashMap guistate = new HashMap();
	public GuiGuiNbpLetter(ElementsPpapdreamMod instance) {
		super(instance, 285);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("ppapdream:textures/nbp_letter.png"));
