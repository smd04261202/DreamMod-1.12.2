...
public class GuiGuiLucidPge extends ElementsPpapdreamMod.ModElement {
	public static int GUIID = 84;
	public static HashMap guistate = new HashMap();
	public GuiGuiLucidPge(ElementsPpapdreamMod instance) {
		super(instance, 303);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("ppapdream:textures/lucid_pge.png"));
