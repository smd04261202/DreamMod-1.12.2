...
public class GuiGuiNewspaper extends ElementsPpapdreamMod.ModElement {
	public static int GUIID = 55;
	public static HashMap guistate = new HashMap();
	public GuiGuiNewspaper(ElementsPpapdreamMod instance) {
		super(instance, 221);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("ppapdream:textures/newspaper.png"));
