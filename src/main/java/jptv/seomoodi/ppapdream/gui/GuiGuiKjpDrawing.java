...
public class GuiGuiKjpDrawing extends ElementsPpapdreamMod.ModElement {
	public static int GUIID = 110;
	public static HashMap guistate = new HashMap();
	public GuiGuiKjpDrawing(ElementsPpapdreamMod instance) {
		super(instance, 409);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("ppapdream:textures/kjp_drawing.png"));
