...
public class GuiGuiPgeMemo01 extends ElementsPpapdreamMod.ModElement {
	public static int GUIID = 59;
	public static HashMap guistate = new HashMap();
	public GuiGuiPgeMemo01(ElementsPpapdreamMod instance) {
		super(instance, 225);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("ppapdream:textures/pge_memo01.png"));
