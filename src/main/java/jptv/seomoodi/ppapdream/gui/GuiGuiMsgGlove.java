...
public class GuiGuiMsgGlove extends ElementsPpapdreamMod.ModElement {
	public static int GUIID = 66;
	public static HashMap guistate = new HashMap();
	public GuiGuiMsgGlove(ElementsPpapdreamMod instance) {
		super(instance, 265);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("ppapdream:textures/msg_glove.png"));
