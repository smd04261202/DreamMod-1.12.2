...
public class GuiGuiLucidDreamHall extends ElementsPpapdreamMod.ModElement {
	public static int GUIID = 41;
	public static HashMap guistate = new HashMap();
	public GuiGuiLucidDreamHall(ElementsPpapdreamMod instance) {
		super(instance, 163);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("ppapdream:textures/dreamhall_hint1.png"));
