...
public class GuiGuiPgeFourcut extends ElementsPpapdreamMod.ModElement {
	public static int GUIID = 14;
	public static HashMap guistate = new HashMap();
	public GuiGuiPgeFourcut(ElementsPpapdreamMod instance) {
		super(instance, 104);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("ppapdream:textures/pge_4cut.png"));
			this.drawTexturedModalRect(this.guiLeft + 0, this.guiTop + -6, 0, 0, 256, 256);
		}
