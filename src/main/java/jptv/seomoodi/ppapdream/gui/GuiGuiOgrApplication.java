...
public class GuiGuiOgrApplication extends ElementsPpapdreamMod.ModElement {
	public static int GUIID = 32;
	public static HashMap guistate = new HashMap();
	public GuiGuiOgrApplication(ElementsPpapdreamMod instance) {
		super(instance, 139);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("ppapdream:textures/ogr_application.png"));
