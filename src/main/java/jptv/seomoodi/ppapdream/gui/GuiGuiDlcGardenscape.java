...
public class GuiGuiDlcGardenscape extends ElementsPpapdreamMod.ModElement {
	public static int GUIID = 10;
	public static HashMap guistate = new HashMap();
	public GuiGuiDlcGardenscape(ElementsPpapdreamMod instance) {
		super(instance, 97);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("ppapdream:textures/dlc_gardenscapes.png"));
			this.drawTexturedModalRect(this.guiLeft + 0, this.guiTop + -2, 0, 0, 256, 256);
		}
