...
public class GuiGuiHsdApplication extends ElementsPpapdreamMod.ModElement {
	public static int GUIID = 30;
	public static HashMap guistate = new HashMap();
	public GuiGuiHsdApplication(ElementsPpapdreamMod instance) {
		super(instance, 137);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("ppapdream:textures/hsd_application.png"));
