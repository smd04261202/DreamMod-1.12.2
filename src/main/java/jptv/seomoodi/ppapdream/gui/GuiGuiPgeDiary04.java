...
public class GuiGuiPgeDiary04 extends ElementsPpapdreamMod.ModElement {
	public static int GUIID = 85;
	public static HashMap guistate = new HashMap();
	public GuiGuiPgeDiary04(ElementsPpapdreamMod instance) {
		super(instance, 307);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("ppapdream:textures/pge_diary04.png"));
