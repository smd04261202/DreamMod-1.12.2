...
public class GuiGuiGroLucidProfile extends ElementsPpapdreamMod.ModElement {
	public static int GUIID = 71;
	public static HashMap guistate = new HashMap();
	public GuiGuiGroLucidProfile(ElementsPpapdreamMod instance) {
		super(instance, 276);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("ppapdream:textures/gro_lucidcompany.png"));
