...
public class GuiGuiBucketList extends ElementsPpapdreamMod.ModElement {
	public static int GUIID = 46;
	public static HashMap guistate = new HashMap();
	public GuiGuiBucketList(ElementsPpapdreamMod instance) {
		super(instance, 171);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("ppapdream:textures/bucketlist.png"));
