...
public class GuiGuiAddlc1 extends ElementsPpapdreamMod.ModElement {
	public static int GUIID = 77;
	public static HashMap guistate = new HashMap();
	public GuiGuiAddlc1(ElementsPpapdreamMod instance) {
		super(instance, 287);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("ppapdream:textures/lucid_addlc.png"));
