...
public class GuiGuiGloApplication extends ElementsPpapdreamMod.ModElement {
	public static int GUIID = 29;
	public static HashMap guistate = new HashMap();
	public GuiGuiGloApplication(ElementsPpapdreamMod instance) {
		super(instance, 136);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("ppapdream:textures/glo_application.png"));
