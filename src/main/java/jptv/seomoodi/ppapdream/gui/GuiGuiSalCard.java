...
public class GuiGuiSalCard extends ElementsPpapdreamMod.ModElement {
	public static int GUIID = 103;
	public static HashMap guistate = new HashMap();
	public GuiGuiSalCard(ElementsPpapdreamMod instance) {
		super(instance, 382);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("ppapdream:textures/sal_idcard.png"));
