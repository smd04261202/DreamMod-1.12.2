...
public class GuiGuiHiddenMemo02 extends ElementsPpapdreamMod.ModElement {
	public static int GUIID = 107;
	public static HashMap guistate = new HashMap();
	public GuiGuiHiddenMemo02(ElementsPpapdreamMod instance) {
		super(instance, 402);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("ppapdream:textures/hiddenmemo02.png"));
