...
public class GuiGuiPgeDiary extends ElementsPpapdreamMod.ModElement {
	public static int GUIID = 50;
	public static HashMap guistate = new HashMap();
	public GuiGuiPgeDiary(ElementsPpapdreamMod instance) {
		super(instance, 184);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("ppapdream:textures/peng_diary1.png"));
