...
public class GuiGuiLucidDreamHallDram extends ElementsPpapdreamMod.ModElement {
	public static int GUIID = 81;
	public static HashMap guistate = new HashMap();
	public GuiGuiLucidDreamHallDram(ElementsPpapdreamMod instance) {
		super(instance, 295);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("ppapdream:textures/ruciddreamhall.png"));
