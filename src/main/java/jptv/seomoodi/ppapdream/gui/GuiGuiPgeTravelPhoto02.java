...
public class GuiGuiPgeTravelPhoto02 extends ElementsPpapdreamMod.ModElement {
	public static int GUIID = 13;
	public static HashMap guistate = new HashMap();
	public GuiGuiPgeTravelPhoto02(ElementsPpapdreamMod instance) {
		super(instance, 103);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("ppapdream:textures/pge_travelphoto02.png"));
			this.drawTexturedModalRect(this.guiLeft + -1, this.guiTop + -4, 0, 0, 256, 256);
		}
