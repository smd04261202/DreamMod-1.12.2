...
public class GuiGuiIOgrBucketlistPoster extends ElementsPpapdreamMod.ModElement {
	public static int GUIID = 20;
	public static HashMap guistate = new HashMap();
	public GuiGuiIOgrBucketlistPoster(ElementsPpapdreamMod instance) {
		super(instance, 115);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("ppapdream:textures/ogr_bucketlist_poster.png"));
			this.drawTexturedModalRect(this.guiLeft + -4, this.guiTop + -5, 0, 0, 256, 256);
		}
