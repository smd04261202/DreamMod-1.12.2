...
public class GuiGuiPgeDiary02 extends ElementsPpapdreamMod.ModElement {
	public static int GUIID = 58;
	public static HashMap guistate = new HashMap();
	public GuiGuiPgeDiary02(ElementsPpapdreamMod instance) {
		super(instance, 224);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("ppapdream:textures/pge_diary02.png"));
